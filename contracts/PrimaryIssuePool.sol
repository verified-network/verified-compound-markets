// Implementation of swap for new issues of security tokens
// (c) Kallol Borah, 2022
...
import "./dmm/interfaces/IDMMCallee.sol";
import "./dmm/interfaces/IDMMFactory.sol";
import "./dmm/interfaces/IDMMPool.sol";
import "./dmm/interfaces/IWETH.sol";
import "./dmm/libraries/DMMLibrary.sol";

import "./interfaces/IMarketMaker.sol";

contract PrimaryIssuePool is IDMMCallee {
    ...
    IMarketMaker primaryIssueManager;

    constructor(IUniswapV2Router02 _uniswapRounter02, address _factory, address _kyberManager) public {
        uniswapRounter02 = _uniswapRounter02;
        weth = IWETH(_uniswapRounter02.WETH());
        factory = _factory;
        primaryIssueManager = IMarketMaker(_kyberManager);
    }
